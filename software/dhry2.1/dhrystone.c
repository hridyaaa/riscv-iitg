...
*****************/
  ...
  print_uart ("Execution starts, %d runs through Dhrystone\n", LOOPS);
  // Begin_clk = 0;
  Begin_clk = rdcyc();
	...
	// End_clk = 100;
	End_clk = rdcyc();
	No_of_clk = End_clk - Begin_clk;
	int Dhrystone_time_ns = No_of_clk*10/LOOPS;
    int Dhrystone_per_sec = 1000000000/Dhrystone_time_ns ;
    int DMIPS = Dhrystone_per_sec/1757;
	
    print_uart ("Frequency    : 100MHz\n");
    print_uart ("No of clocks : %d \n", No_of_clk );
    print_uart ("Dhry per sec : %d \n", Dhrystone_per_sec );
    print_uart ("DMIPS        : %d \n", DMIPS );
    print_uart("\nEnd of Program\n\n");
